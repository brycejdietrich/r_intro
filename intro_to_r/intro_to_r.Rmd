...
No, the mean for the "present" data set is `r round(mean(present$boys)/mean(arbuthnot$boys))` times larger than the mean for "arbuthnot".
...
What do you see? Does Arbuthnot's observation about boys being born in greater proportion than girls hold up in the U.S.? Include the plot in your response.
